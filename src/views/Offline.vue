<template>
  <section class="min-vh-100 position-relative bg-white">
    <svg
        ...
        <div class="col-12 my-auto">
          <div class="mb-3 w-100">
            <div class="text-center w-100">
              <img :src="`${publicPath}img/offline.png`" class="img-fluid" />
              <h4 class="mb-2 font-weight-bold">You're offline</h4>
              <p>
                You don't have internet connection. Please connect to the
                internet and try again
              </p>
              <a
                :href="$router.resolve($route.name).href"
    ...
    <svg
      class="floating-shape position-fixed bottom-0"
      xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink"
      width="181"
      height="76.649"
